...
class ToonilyRedirected extends paperback_extensions_common_1.Source {
    ...
    get sourceTags() { return [{ text: "18+", type: paperback_extensions_common_1.TagType.YELLOW }, { text: "Country-Unlocked", type: paperback_extensions_common_1.TagType.GREEN }]; }
    ...
    getViewMoreItems(data, key, metadata) {
        ...
        if (currPage < lastPage) {
            ...
            returnObject.nextPage = createRequestObject({
                url: `${TOONILY_DOMAIN}/site/page/${metadata.page}`,
                method: 'GET',
                metadata: metadata
            });
            console.log(`Requesting view more for ${TOONILY_DOMAIN}/site/page/${metadata.page}`);
        }
...
exports.ToonilyRedirected = ToonilyRedirected;
