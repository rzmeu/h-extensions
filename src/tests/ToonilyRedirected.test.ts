...
import { ToonilyRedirected } from '../ToonilyRedirected/ToonilyRedirected';

describe('Toonily Redirected Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: Source = new ToonilyRedirected(cheerio);
