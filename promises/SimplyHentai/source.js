...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SimplyHentai = exports.SimplyHentaiInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const SimplyHentaiParser_1 = require("./SimplyHentaiParser");
const SH_DOMAIN = 'https://www.simply-hentai.com';
const API_URL = 'https://api.simply-hentai.com/v3';
const method = 'GET';
exports.SimplyHentaiInfo = {
    version: '1.0.2',
    name: 'SimplyHentai',
    icon: 'icon.png',
    author: 'chronos',
...
class SimplyHentai extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        return createPagedResults({
            results: SimplyHentaiParser_1.parseMangaItems(this.extractResultFromResponse(response)),
    ...
    async getMangaDetails(mangaId) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        return SimplyHentaiParser_1.parseMangaDetails(this.extractResultFromResponse(response));
    }
    async getChapters(mangaId) {
        return SimplyHentaiParser_1.parseChapters(mangaId);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        return SimplyHentaiParser_1.parseChapterDetails(result, mangaId, chapterId);
    }
    async searchRequest(query, metadata) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        return createPagedResults({
            results: SimplyHentaiParser_1.parseSearchMangaItems(this.extractResultFromResponse(response)),
            metadata: { nextPage: page + 1 }
        });
    }
    async getSearchTags() {
        return SimplyHentaiParser_1.getTags();
    }
}
exports.SimplyHentai = SimplyHentai;

},{"./SimplyHentaiParser":49,"paperback-extensions-common":5}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.getTags = exports.parseSearchMangaItems = exports.parseMangaItems = exports.parseChapterDetails = exports.parseChapters = exports.parseMangaDetails = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
